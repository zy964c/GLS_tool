...
class AnnotationFactory(object):
    ...
    def __init__(self):
        self.annots = {'FL1': ['Inboard Facing Out - Lower Support', 'Wire Harness And Wire Splice Location'],
                       ...
                       'JD 10': ['Outboard Facing In - Middle Support', 'JD11 Ring Post to 1510-2 Bracket'],
                       ...
                       'FL10': ['Inboard Facing Out - Lower Support', 'Sidewall Light Termination Plug Marker Installation'],
                       'FL11': ['Inboard Facing Out - Top Support', 'Connector to P-Clamp Installation'],
                       'FL12': ['Inboard Facing Out - Top Support', 'Ceiling Light Termination Plug Marker Installation'],
                       ...
                       'term_plug_marker_sidewall': ['Inboard Facing Out - Lower Support', 'Sidewall Light Termination Plug Marker Installation'],
                       'term_plug_marker_ceiling': ['Inboard Facing Out - Top Support', 'Ceiling Light Termination Plug Marker Installation'],
                       'term_plug_marker_nofar': ['Inboard Facing Out - Top Support', 'NOFAR Termination Plug Marker Installation'],
                       'sidewall_light_marker': ['Outboard Facing In - Middle Support', 'Sidewall Light Marker Installation'],
                       'nofar_light_marker': ['Inboard Facing Out - Top Support', 'NOFAR Light Marker Installation'],
                       'power_supply_marker': ['Inboard Facing Out - Top Support', 'Power Supply Marker Installation']}
